package com.invillia.denver.rabbitadminproducer.controller;

import com.invillia.denver.rabbitadminproducer.config.HeaderConfig;
import com.invillia.denver.rabbitadminproducer.model.Product;
...
public class SampleRabbitController {
    ...
    public void executeHeaderExample(@PathVariable("test") String test,
        ...
        rabbitTemplate.convertAndSend(HeaderConfig.ADMIN_LISTEN_HEADER_EXCHANGE, "", product, m -> {
