...
@Service
public class OtherAdminListenTopicListener implements MessageListener {

    private Logger LOG = LoggerFactory.getLogger(OtherAdminListenTopicListener.class);

    private final ObjectMapper objectMapper;

    public OtherAdminListenTopicListener(ObjectMapper objectMapper) {
    ...
    public void onMessage(Message message) {
        try {
            ...
            LOG.info(QueueConstants.LOG_MESSAGE_ROUTING_KEY, QueueConstants.OTHER_ADMIN_LISTEN_TOPIC_QUEUE, routingKey, product);
        } catch (IOException e) {
