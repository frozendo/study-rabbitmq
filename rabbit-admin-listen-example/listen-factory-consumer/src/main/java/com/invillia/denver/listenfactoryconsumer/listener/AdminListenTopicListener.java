...
@Service
public class AdminListenTopicListener implements MessageListener {

    private Logger LOG = LoggerFactory.getLogger(AdminListenTopicListener.class);

    private final ObjectMapper objectMapper;

    public AdminListenTopicListener(ObjectMapper objectMapper) {
    ...
    public void onMessage(Message message) {
        try {
            ...
            LOG.info(QueueConstants.LOG_MESSAGE_ROUTING_KEY, QueueConstants.ADMIN_LISTEN_TOPIC_QUEUE, routingKey, product);
        } catch (IOException e) {
