...
@Service
public class OtherAdminListenHeaderListener implements MessageListener {

    private Logger LOG = LoggerFactory.getLogger(OtherAdminListenHeaderListener.class);

    private final ObjectMapper objectMapper;

    public OtherAdminListenHeaderListener(ObjectMapper objectMapper) {
    ...
    public void onMessage(Message message) {
        try {
            ...
            LOG.info(QueueConstants.LOG_MESSAGE_ROUTING_KEY, QueueConstants.OTHER_ADMIN_LISTEN_HEADER_QUEUE, routingKey, product);
        } catch (IOException e) {
